...
Make sure you've a mechanism to get authToken from your server-side, which you would have received as part of [Add Participant](/guides/sim-stack/build-live-video-app#step-2-add-participants) call.
