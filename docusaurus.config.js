...
const defaultSettings = {
  breadcrumbs: true,
  editUrl: 'https://github.com/orangewoodsim/orangewood-docs/tree/main',
...
const config = {
      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            label: 'Help',
            type: 'dropdown',
            className: 'orangewood-dropdown resources-dropdown',
            items: [
              {
                type: 'html',
                value: resourcesHTML,
                className: 'orangewood-dropdown',
              },
            ],
          },
          {
  ...
  onBrokenLinks: 'ignore',  // Add this line at the root level
};
