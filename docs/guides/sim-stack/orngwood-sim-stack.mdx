...
We offfer two methods to test and work with simulation

1. Setup in your host Ubuntu 20.04.6 machine
2. Setup Using **[Docker](https://docs.docker.com/)**
...
## 4) Setting Up Orangewood Simulation on Docker
...
```
## 5) Install Docker in Host Machine
...
## 6) Build or Pull Docker Image of Orangewood Simulation
...
## 7) Run Docker for running simulation
...
```bash
#Upgrading pip install owl-robot-sdk --upgrade
pip install owl-robot-sdk --upgrade

root@025d7e913e06:/home/robot/orangewood_ws
```
